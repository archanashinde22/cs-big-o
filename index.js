...
// ANSWER:O(n)  where is n length of numbers array
...
// 7) -------------------------------------------------------
let numbers1 = [76, 35, 73, 13, 4, 88, 23, 12, 86, 1, 54, 9, 10, 2];
...
// ANSWER: let squareofNum = numbers.map(num=> num*num)  //Liner
...
// ANSWER: As we are looping for loop for n (i.e.length of string) times.
